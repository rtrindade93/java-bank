...
public class AccountTransactionView extends AbstractView {
    ...
    public void show() {
        ...
        if (transactionController.getNumberOfLoginCustomerAccounts() == 0) {
            showNoAccounts();
            return;
        }
    ...
    private String buildAccountList() {
        ...
        for (Integer id : transactionController.getLoginCustomerAccounts()) {
            builder.append(id);
            builder.append(" ");
        }
    ...
    private int scanAccount() {
        ...
        IntegerSetInputScanner scanner = new IntegerSetInputScanner(transactionController.getLoginCustomerAccounts());
